...
USAGE
-----
    python3 render-audit-pdf.py --spec /tmp/<slug>-audit.json --out /path/to.pdf
    # In a skill, reference it CWD-independently:
    #   python3 ${CLAUDE_SKILL_DIR}/scripts/render-audit-pdf.py --spec ... --out ...
